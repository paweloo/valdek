...
import { g as FileSpreadsheet, h as FileText, t as X, u as Scale } from "../_libs/lucide-react.mjs";
import { g as cn, l as fullName, r as useValdek, u as monthLabel, v as formatPln } from "./router-1VjxVlmk.mjs";
import { r as Button, t as AppShell } from "./badge-C1Z3XjVs.mjs";
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Wgraj ewidencję z Excela i listę operacji z mBanku. Valdek zestawi nazwiska, grupy i kwoty — a kwiatki z tytułów przelewów zostawi do Twojej decyzji."
					})
				] })
			}),
			seedBanner && seeded ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "To podgląd na Twojej ewidencji (Zajkowie, grupy seniorów). Wgraj Excel i PDF z mBanku, żeby pracować na aktualnych plikach — nic nie wychodzi z tej przeglądarki."
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Bez wpłaty" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardDescription, { children: [
					...
					"."
				] })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { children: [unpaidPeople.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted-foreground",
				...
				}), unpaidPeople.length > 8 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					}), unmatched.slice(0, 4).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						className: "flex items-center justify-between gap-3 py-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "min-w-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								className: "text-xs text-muted-foreground",
								children: "nierozpoznany przelew"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
