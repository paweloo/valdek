...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DrK5C4N1.js
...
function matchTransfers(params) {
	...
	for (const transfer of transfers) {
		...
		if (issue === "over") best.reasons.push(transfer.amount >= best.participant.monthlyFee * 1.8 ? "kwota wygląda na dwa miesiące" : "nadpłata");
...
function demoTransfers(statementId = "st-demo") {
	return [{
		id: "tr-julia",
		statementId,
		date: "2026-09-02",
...
function demoMatches() {
	return [{
		...
		amountIssue: "partial",
		reasons: [
			"pełne imię i nazwisko w tytule",
			"grupa „SENIORZY II”",
			"kwota niższa niż stawka"
		]
	}];
}
...
var useValdek = create()(persist((set, get) => ({
	...
	setSourceWorkbook: (buf, fileName) => set({
		sourceWorkbookB64: bufferToB64(buf),
		sourceFileName: fileName || "UCZESTNICY.xlsx"
	}),
	seedDemo: () => set({
		...demoSnapshot(),
		hydrated: true
	...
	(0, import_react.useEffect)(() => {
		...
		async function boot() {
			try {
				...
				if (!useValdek.getState().sourceWorkbookB64) fetch("/ewidencja-szablon.xlsx").then((res) => res.ok ? res.arrayBuffer() : null).then((buf) => {
					if (buf && !useValdek.getState().sourceWorkbookB64) useValdek.getState().setSourceWorkbook(buf, "UCZESTNICY.xlsx");
				}).catch(() => {});
			} catch {
				try {
...
var styles_default = "/assets/styles-C42Trfmb.css";
var APP_NAME = "Valdek";
var Route$4 = createRootRoute({
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(HydrateStore, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster$1, {})] }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	})
});
var $$splitComponentImporter$3 = () => import("./routes-CH1WLK6c.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./rozliczenie-CNJTpHgx.mjs");
var Route$2 = createFileRoute("/rozliczenie")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./uczestnicy-D6rB_4_M.mjs");
var Route$1 = createFileRoute("/uczestnicy")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./wyciag-B4ckPBYf.mjs");
...
//#endregion
export { parseLooseDate as _, interpretExcelRow as a, b64ToBuffer as c, formatPln as d, uid as f, normalizeText as g, monthShort as h, guessMapping as i, cn as l, monthLabel as m, receivedFor as n, readSpreadsheet as o, fullName as p, useValdek as r, DEMO_STATEMENT_LINES as s, router_exports as t, downloadBlob as u, parsePln as v, seasonMonths as y };
