...
import { m as FileText, o as Trash2 } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { _ as parseLooseDate, d as formatPln, f as uid, g as normalizeText, l as cn, m as monthLabel, r as useValdek, s as DEMO_STATEMENT_LINES, v as parsePln } from "./router-DrK5C4N1.mjs";
import { n as Badge, r as Button, t as AppShell } from "./badge-DXSOSOLP.mjs";
import { t as Textarea } from "./textarea-_Wu-gvR0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/wyciag-B4ckPBYf.js
...
function FileDrop({ accept, onFile, children, className, label }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		className: cn("relative flex min-h-44 w-full flex-col items-center justify-center overflow-hidden rounded-xl bg-card px-6 py-8 text-center shadow-[var(--shadow-border)]", over && "bg-accent", className),
...
function amountsIn(line) {
	...
	while (m = re.exec(line)) {
		...
		if (value == null || Math.abs(value) >= 1e5) continue;
		out.push({
			raw,
			value,
			index: m.index
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						". Wpłaty przychodzące idą do rozliczenia, zakupy kartą Valdek odkłada na bok."
					]
				})
			] }),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FileDrop, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Eksport „Lista operacji” z mBanku."
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
