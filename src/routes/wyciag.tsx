      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <header>
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            Lista operacji mBanku za {monthLabel(selectedMonth)} — ta z kolumnami data, opis, kategoria, kwota. Wpłaty przychodzące idą do rozliczenia, zakupy kartą i BLIK Valdek odkłada na bok. Parsowanie tylko w tej przeglądarce.
          </p>
        </header>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <FileDrop accept="application/pdf,.pdf" onFile={onPdf} label="Wgraj PDF z wyciągiem">
            ...
            <p className="mt-2 max-w-sm text-sm text-muted-foreground">
              Eksport „Lista operacji” z mBanku albo inny PDF z datą, kwotą i tytułem.
            </p>
          </FileDrop>
